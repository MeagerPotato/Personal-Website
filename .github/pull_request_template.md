...
<!-- One or two sentences. Link the plan step: e.g. "Phase 1 step 5 (docs/PLAN.md §6)". -->

## How to check it

<!-- What a reviewer should open or run. The Cloudflare preview URL appears as a comment on this PR. -->
